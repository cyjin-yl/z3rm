...
You can now optionally specify a **version** of Zed to install using the `Z3RM_VERSION` environment variable:
...
curl -f https://zed.dev/install.sh | Z3RM_VERSION=0.216.0 sh
```
