        ...
        pretty_assertions::assert_eq!(
            ...
            [
                (
                    ...
                    Some("$ZERMINAL_CUSTOM_TYPESCRIPT_VITEST_PACKAGE_PATH".into()),
                ),
                (
                    "vitest test $ZERMINAL_SYMBOL".into(),
                    Some("$ZERMINAL_CUSTOM_TYPESCRIPT_VITEST_PACKAGE_PATH".into()),
                ),
                (
                    "mocha file test".into(),
                    Some("$ZERMINAL_CUSTOM_TYPESCRIPT_MOCHA_PACKAGE_PATH".into()),
                ),
                (
                    "mocha test $ZERMINAL_SYMBOL".into(),
                    Some("$ZERMINAL_CUSTOM_TYPESCRIPT_MOCHA_PACKAGE_PATH".into()),
                ),
                (
