...
const URL_REGEX: &str = r#"(ipfs:|ipns:|magnet:|mailto:|gemini://|gopher://|https://|http://|news:|file://|git://|ssh:|ftp://|z3rm://)[^\u{0000}-\u{001F}\u{007F}-\u{009F}<>"\s{-}\^⟨⟩`']+"#;
...
mod tests {
    ...
    fn test_url_regex() {
        ...
        re_test(
            URL_REGEX,
            "open z3rm://channel/the-channel and z3rm://settings/theme now",
            vec!["z3rm://channel/the-channel", "z3rm://settings/theme"],
        );
    }
